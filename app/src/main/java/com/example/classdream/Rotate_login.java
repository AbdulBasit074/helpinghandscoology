...
public class Rotate_login extends Transition {
  ...
  public Rotate_login(Context context, AttributeSet attrs) {
    super(context, attrs);
    if (attrs != null) {
      TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.Rotate_login);
      startAngle = array.getFloat(R.styleable.Rotate_login_start_angle, 0f);
      endAngle = array.getFloat(R.styleable.Rotate_login_end_angle, 0f);
      array.recycle();
    }
  }
