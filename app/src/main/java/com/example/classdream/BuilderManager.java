...
public class BuilderManager {
    ...
    static int getImageResourceedit(int[] imageResources) {
        if (imageResourceIndex >= imageResources.length) imageResourceIndex = 0;
        return imageResources[imageResourceIndex++];
    }
    ...
    static TextOutsideCircleButton.Builder getTextOutsideCircleButtonBuilder(String value) {
    ...
    static TextOutsideCircleButton.Builder getTextOutsideCircleButtonBuilder(String value,int[] image) {
        return new TextOutsideCircleButton.Builder()
                .isRound(false)
                .normalImageRes(getImageResourceedit(image))
                .normalText(value);
