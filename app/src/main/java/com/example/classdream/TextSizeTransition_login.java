 ...
 * TextView gravity.
 */
public class TextSizeTransition_login extends Transition {
  ...
  public TextSizeTransition_login() {
   ...
   */
  public TextSizeTransition_login(Context context, AttributeSet attrs) {
    super(context, attrs);
    addTarget(TextView.class);
  }
