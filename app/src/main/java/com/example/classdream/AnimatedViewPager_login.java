...
public class AnimatedViewPager_login extends ViewPager {

  private int duration;

  public AnimatedViewPager_login(Context context) {
    super(context);
    postInitViewPager();
  }

  public AnimatedViewPager_login(Context context, AttributeSet attrs) {
    super(context, attrs);
    postInitViewPager();
  }
